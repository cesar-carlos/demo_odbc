...
abstract class DatabaseDriver {
  ...
  Future<Result<List<Map<String, dynamic>>>> execute(String query, {List<dynamic>? params});

  /// Executa uma query SQL retornando um Stream para leitura linha-a-linha (Cursor).
  /// Ideal para grandes volumes de dados.
  Future<Result<Stream<Map<String, dynamic>>>> executeCursor(String query, {List<dynamic>? params});
